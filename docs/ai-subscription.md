...
The AI features in the AtoM-AHG platform - Named Entity Recognition (NER),
handwriting text recognition (HTR), OCR, machine translation, summarisation, AI
description suggestions, and AI condition assessment - are an **optional paid
subscription**. They are **not part of the base platform** and are not included
in the standard licence.

## What is and is not included

The **base platform** - cataloguing and description, digital objects, access
and rights, the GLAM modules, search, IIIF, reporting, and everything else - is
fully functional with no AI subscription.

The **AI features** ship inside the AHG plugins but are **dormant by default**.
The platform is an AI *client*: it never hosts an AI model. Every AI operation
is a call to the **AHG AI gateway**, a hosted service operated by The Archive
and Heritage Group. Without an active subscription there is no gateway
credential, so the AI features stay switched off - the AI menu items simply
return nothing.
...
- AI inference-provenance recording and signing
...
Your system operator enters the gateway credentials in the **AI Services
settings** of the AHG admin area:
...
- **AI Governance** - operator visibility into AI models and usage.
