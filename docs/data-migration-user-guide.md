...
| **Museum** | Collections Procedures | Museum objects with acquisition, location data |
...
1. Select "Museum (Collections Procedures)" format
...
### Museum Import (Collections Procedures)
...
| `museum_sample.csv` | Museum | 5 | Collections Procedures objects with materials, techniques, locations |
...
- Collections Procedures-compliant field names
...
| Version | Changes |
|---------|---------|
| 1.4.0 | Universal validation framework, sector-specific validators (ISAD-G, Collections Procedures, MARC/RDA, CCO, Dublin Core), sector CLI import tasks, validation-only mode, sample CSV files, mapping profile export/import |
